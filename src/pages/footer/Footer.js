...
const Footer = () => {
    return (
       <Stack spacing={2} direction={{xs:"column",sm:"row"}} justifyContent="space-between" alignItems="center" sx={{backgroundColor:"#FFF9EB",p:3,px:{lg:8,xs:3}}}>
              <Typography variant="body2" sx={{fontStyle:"italic",fontFamily:"Poppins",color:"#212B36",fontWeight:500}}>Copyright © 2024 Neha Chhillar. All Rights Reserved.</Typography>
